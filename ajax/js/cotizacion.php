...
function limpiarTablaQuote(){
	...
	htmlRows += '<td><input type="text" name="quantityTambosQuote[]" id="quantityTambosQuote_'+count+'" placeholder="Cantidad" class="form-control inputfield-details1" autocomplete="off"></td>';
