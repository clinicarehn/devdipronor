...
function limpiarTablaFactura(){
	...
	htmlRows += '<td><input type="text" name="quantityTambos[]" id="quantityTambos_'+count+'" placeholder="Cantidad" class="form-control inputfield-details1" autocomplete="off"></td>';
